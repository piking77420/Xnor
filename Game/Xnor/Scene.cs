...
public class Scene : global::System.IDisposable {
  ...
  public SWIGTYPE_p_uint32_t GetEntityIndex(Entity entity) {
    SWIGTYPE_p_uint32_t ret = new SWIGTYPE_p_uint32_t(CorePINVOKE.Scene_GetEntityIndex(swigCPtr, Entity.getCPtr(entity)), true);
    return ret;
  }

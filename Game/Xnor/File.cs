...
public class File : Entry {
  ...
  public File.Type GetType() {
    File.Type ret = (File.Type)CorePINVOKE.File_GetType(swigCPtr);
    return ret;
  }
  ...
  public SWIGTYPE_p_int64_t GetSize() {
    SWIGTYPE_p_int64_t ret = new SWIGTYPE_p_int64_t(CorePINVOKE.File_GetSize(swigCPtr), true);
    return ret;
  }

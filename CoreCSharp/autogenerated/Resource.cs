...
public class Resource : global::System.IDisposable {
  ...
  public virtual void CreateInRhi() {
    CoreCNative.Resource_CreateInRhi(swigCPtr);
  }

  public virtual void DestroyInRhi() {
    CoreCNative.Resource_DestroyInRhi(swigCPtr);
  }
  ...
  public virtual bool Reload(SWIGTYPE_p_unsigned_char buffer, long length, bool reloadInRhi) {
    bool ret = CoreCNative.Resource_Reload__SWIG_0(swigCPtr, SWIGTYPE_p_unsigned_char.getCPtr(buffer), length, reloadInRhi);
    return ret;
  }
  ...
  public virtual bool Reload(SWIGTYPE_p_XnorCore__PointerT_XnorCore__File_t file, bool reloadInRhi) {
    bool ret = CoreCNative.Resource_Reload__SWIG_2(swigCPtr, SWIGTYPE_p_XnorCore__PointerT_XnorCore__File_t.getCPtr(file), reloadInRhi);
    if (CoreCNative.SWIGPendingException.Pending) throw CoreCNative.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual bool Reload(bool reloadInRhi) {
    bool ret = CoreCNative.Resource_Reload__SWIG_4(swigCPtr, reloadInRhi);
    return ret;
  }
  ...
  public bool IsLoadedInRhi() {
    bool ret = CoreCNative.Resource_IsLoadedInRhi(swigCPtr);
    return ret;
  }

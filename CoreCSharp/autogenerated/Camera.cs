...
public class Camera : global::System.IDisposable {
  ...
  public void LookAt( Vector3  at) {
    CoreCNative.Camera_LookAt__SWIG_0(swigCPtr,  ref at );
  }

  public void LookAt( Vector3  at,  Vector3  upVector) {
    CoreCNative.Camera_LookAt__SWIG_1(swigCPtr,  ref at ,  ref upVector );
  }
  ...
  public static  Matrix  Perspective(float fovy, float aspect, float zNear, float zFar) {
			Matrix ret = CoreCNative.Camera_Perspective(fovy, aspect, zNear, zFar);
			return ret;
		}

  public static  Matrix  LookAtRH( Vector3  eye,  Vector3  center,  Vector3  up) {
			Matrix ret = CoreCNative.Camera_LookAtRH( ref eye ,  ref center ,  ref up );
			return ret;
		}

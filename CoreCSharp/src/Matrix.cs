...
namespace Xnor.Core
{
    public struct Matrix
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return CoreC.Equals(M00, other.M00) && CoreC.Equals(M01, other.M01) && CoreC.Equals(M02, other.M02) && CoreC.Equals(M03, other.M03)
                && CoreC.Equals(M10, other.M10) && CoreC.Equals(M11, other.M11) && CoreC.Equals(M12, other.M12) && CoreC.Equals(M13, other.M13)
                && CoreC.Equals(M20, other.M20) && CoreC.Equals(M21, other.M21) && CoreC.Equals(M22, other.M22) && CoreC.Equals(M23, other.M23)
                && CoreC.Equals(M30, other.M30) && CoreC.Equals(M31, other.M31) && CoreC.Equals(M32, other.M32) && CoreC.Equals(M33, other.M33);
        }

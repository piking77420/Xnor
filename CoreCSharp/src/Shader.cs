...
public class Shader : Resource {
  ...
  public override bool Load(SWIGTYPE_p_unsigned_char buffer, long length) {
    bool ret = CorePINVOKE.Shader_Load__SWIG_0(swigCPtr, SWIGTYPE_p_unsigned_char.getCPtr(buffer), length);
    return ret;
  }
  ...
  public bool Load(string buffer, long length, ShaderType type) {
    bool ret = CorePINVOKE.Shader_Load__SWIG_2(swigCPtr, buffer, length, (int)type);
    return ret;
  }
  ...
  public void SetInt(string keyName, int value) {
    CorePINVOKE.Shader_SetInt(swigCPtr, keyName, value);
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void SetFloat(string keyName, float value) {
    CorePINVOKE.Shader_SetFloat(swigCPtr, keyName, value);
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetVec2(string keyName, Vector2 value) {
    CorePINVOKE.Shader_SetVec2(swigCPtr, keyName, Vector2.getCPtr(value));
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetVec3(string keyName, Vector3 value) {
    CorePINVOKE.Shader_SetVec3(swigCPtr, keyName, Vector3.getCPtr(value));
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetVec4(string keyName, Vector4 value) {
    CorePINVOKE.Shader_SetVec4(swigCPtr, keyName, Vector4.getCPtr(value));
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetMat4(string keyName, Matrix value) {
    CorePINVOKE.Shader_SetMat4(swigCPtr, keyName, Matrix.getCPtr(value));
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
  }

  public uint GetId() {
    uint ret = CorePINVOKE.Shader_GetId(swigCPtr);
    return ret;
  }

...
public class Cubemap : Resource {
  ...
  public void BindTexture(uint unit) {
    CorePINVOKE.Cubemap_BindTexture(swigCPtr, unit);
  }

  public void UnBindTexture(uint unit) {
    CorePINVOKE.Cubemap_UnBindTexture(swigCPtr, unit);
  }

  public uint GetId() {
    uint ret = CorePINVOKE.Cubemap_GetId(swigCPtr);
    return ret;
  }

  public Vector2i GetSize() {
    Vector2i ret = new Vector2i(CorePINVOKE.Cubemap_GetSize(swigCPtr), true);
    return ret;
  }

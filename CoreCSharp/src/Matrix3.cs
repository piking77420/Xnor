namespace Xnor.Core
{
    public struct Matrix3(float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22)
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return CoreC.Equals(M00, other.M00) && CoreC.Equals(M01, other.M01) && CoreC.Equals(M02, other.M02)
                && CoreC.Equals(M10, other.M10) && CoreC.Equals(M11, other.M11) && CoreC.Equals(M12, other.M12)
                && CoreC.Equals(M20, other.M20) && CoreC.Equals(M21, other.M21) && CoreC.Equals(M22, other.M22);
        }

...
public class Entity : Serializable {
  ...
  internal Entity(global::System.IntPtr cPtr, bool cMemoryOwn) : base(CorePINVOKE.Entity_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public bool OperatorEq(Entity entity) {
    bool ret = CorePINVOKE.Entity_OperatorEq(swigCPtr, Entity.getCPtr(entity));
    if (CorePINVOKE.SWIGPendingException.Pending) throw CorePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

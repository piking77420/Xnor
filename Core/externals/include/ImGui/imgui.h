...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderAngle3(const char* label, float v_rad[3], float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char* format = "%.0f deg", ImGuiSliderFlags flags = 0);
